...
export function AboutExclusivityBlock() {
      ...
      <Container className="relative z-[1]">
        ...
        >
          ...
          <h2 className="mb-5 font-display text-[2rem] leading-[1.2] tracking-[-0.02em] text-white md:text-[2.5rem]">
            Selected as the exclusive multi-year premises management partner for Aldar Properties and Asteco.
          </h2>
          ...
          >
            <div className="flex flex-col items-start">
              <p className="font-heading text-[40px] font-extrabold leading-none tracking-[-2px] text-[var(--text-brand)]">
