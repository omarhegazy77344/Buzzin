...
const proofCards = [
  {
    ...
    body: "Multi-year partner. Work permit system deployed across all Aldar residential communities and commercial assets in the UAE.",
    tag: "Real Estate",
    ...
    <>
      ...
      <main>
        ...
        <TransformationShowcase
          rows={beforeAfter}
          title="What changes when permits go fully digital."
          subtitle={null}
        />
