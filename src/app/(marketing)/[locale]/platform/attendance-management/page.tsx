...
export const metadata: Metadata = {
  ...
  description:
    "Digital staff attendance system for UAE schools and corporates. NFC card or phone tap-in. Real-time late alerts. Shift reports. Audit-ready logs. Trusted by Taaleem, Brighton College, and 550+ organisations.",
  openGraph: {
    ...
    <>
      ...
      <main>
        ...
        <TransformationShowcase
          rows={beforeAfter}
          title="What changes when attendance goes from paper to platform."
          subtitle={null}
        />
