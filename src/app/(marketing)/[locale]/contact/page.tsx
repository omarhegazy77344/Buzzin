            ...
            <div className="py-16 md:py-20">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <a
                  ...
                  className="group rounded-[14px] border-[1.5px] border-[var(--border-default)] bg-white p-6 transition-all duration-[220ms] hover:border-[rgba(245,166,35,0.4)] hover:-translate-y-[2px]"
                >
                ...
                <a
                  ...
                  className="group rounded-[14px] border-[1.5px] border-[var(--border-default)] bg-white p-6 transition-all duration-[220ms] hover:border-[rgba(37,211,102,0.4)] hover:-translate-y-[2px]"
                >
